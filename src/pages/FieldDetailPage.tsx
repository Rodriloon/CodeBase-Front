...
import { Calendar, Clock, MapPin, Users, TicketCheck, XCircle } from "lucide-react"
    ...
    <div className="animate-in fade-in duration-500">
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
             ...
             <Badge variant="outline" className="text-sm py-1 px-3 gap-1">
                <MapPin className="w-4 h-4"/> {field.surface.replace("_", " ")}
             </Badge>
             <Badge variant={field.isIndoor ? "secondary" : "default"} className="text-sm py-1 px-3">
                {field.isIndoor ? "Techada" : "Al Aire Libre"}
             </Badge>
        </div>
        <p className="text-gray-600">{field.description || "Sin descripción disponible."}</p>
      </div>
