    ...
    <div className="animate-in fade-in duration-500">
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          <Badge
            variant={field.isIndoor ? "secondary" : "default"}
        ...
        <p className="text-gray-600">
          {field.description || "Sin descripción disponible."}
        </p>
      </div>
            ...
            {HOURS.map((hour) => {
              ...
              return (
                ...
                >
                  ...
                  {occupied ? (
                    <span className="text-[10px] flex items-center gap-1 text-red-500 font-bold">
