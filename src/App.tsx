    ...
    <BrowserRouter>
        ...
        <header className="border-b shadow-sm sticky top-0 z-40" style={{ backgroundColor: currentTheme.primaryColor }}>
            ...
            <nav className="hidden md:flex gap-6 font-medium">
                <Link to="/" className="hover:opacity-80 cursor-pointer transition-opacity">Inicio</Link>
            ...
            <div className="md:hidden">
                ...
                <SheetContent side="right">
                    ...
                    <Link to="/" className="text-lg font-medium hover:text-primary cursor-pointer p-2 rounded-md hover:bg-accent">
                        Inicio
                    </Link>
